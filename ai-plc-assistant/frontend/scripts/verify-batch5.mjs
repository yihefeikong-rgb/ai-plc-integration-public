 ...
 * Batch 5 验证截图
 *
 * Dashboard 重构为工程工作台总览（5 区域）+ 旧组件清理 + F-033 修复。
 * 截 4 个核心页面 x 2 尺寸 = 8 张，作为 Batch 5 后基线。
 */
...
const OUT_DIR = resolve('../../docs/frontend/screenshots/batch5-verify')
...
const PAGES = [
  { name: 'dashboard', action: async (page) => { await page.goto(BASE_URL + '/'); await page.waitForTimeout(1200); } },
  {
    name: 'chat',
    action: async (page) => {
